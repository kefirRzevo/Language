...
make: 
	...
	$(CXX) -g -pipe $(CXXFLAGS) -o obj/array.o 		-c src/array/array.cpp
	$(CXX) -g -pipe $(CXXFLAGS) -o obj/lexer.o 	    -c frontend/lexer.cpp
	$(CXX) -o $(TARGET) obj/main.o obj/array.o obj/lexer.o

lex:
	$(CXX) -g -pipe $(CXXFLAGS) -o obj/lexer.o -c frontend/lexer.cpp

sources: main.cpp src/array/array.cpp
	$(CXX) -g -pipe $(CXXFLAGS) -o obj/main.o 		-c main.cpp
	$(CXX) -g -pipe $(CXXFLAGS) -o obj/array.o 		-c src/array/array.cpp

$(TARGET):	obj/array.o obj/lexer.o obj/main.o
	$(CXX) -o $(TARGET) obj/array.o obj/lexer.o obj/main.o
